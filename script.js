  ...
  document.addEventListener("DOMContentLoaded", function() {
    const slides = document.querySelectorAll('.slide3'); // Cambiado el selector para el nuevo slider
    let currentSlide = 0;
    ...
    document.getElementById('prevBtn3').addEventListener('click', function() { // Cambiado el ID del botón anterior para el nuevo slider
      showSlide(currentSlide - 1);
    });
  
    document.getElementById('nextBtn3').addEventListener('click', function() { // Cambiado el ID del botón siguiente para el nuevo slider
      showSlide(currentSlide + 1);
    });
  });
